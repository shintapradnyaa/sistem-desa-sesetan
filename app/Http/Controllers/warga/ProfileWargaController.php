...
class ProfileWargaController extends Controller
{
    ...
    {
        $data = User::all();
        return view('pages.warga.edit_pengguna', compact('data'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('pages.warga.edit_pengguna', $data);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('edit_profile_warga/edit/' . $id)->with('message', 'Data Berhasil Diperbaharui');
    }

    public function edit_password($id)
    {
        return view('pages.warga.edit_password_warga');
    }
