...
class ProfileBendesaController extends Controller
{
    public function index()
    {
        $data = User::all();
        return view('pages.bendesa.edit_profile_bendesa', compact('data'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('pages.bendesa.edit_profile_bendesa', $data);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('edit_profile_bendesa/edit/' . $id)->with('message', 'Data Berhasil Diperbaharui');
    }

    public function edit_password($id)
    {
        return view('pages.bendesa.edit_password');
    }
