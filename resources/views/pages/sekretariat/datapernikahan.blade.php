                ...
                <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form class="row g-3" action="{{ url('/store_data_pernikahan_sekretariat') }}"
                            ...
                            <tbody>
                                @foreach ($data as $row_pernikahan)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('show_data_pernikahan_sekretariat', $row_pernikahan->id) }}"
                                                class="btn btn-sm btn-info">
                                                <i class="fas fa-info-circle"></i>
                                            </a>
                                            <a href="{{ url('edit_data_pernikahan_sekretariat', $row_pernikahan->id) }}"
                                                class="btn btn-sm btn-warning">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <a href="{{ url('/delete_data_pernikahan_sekretariat', $row_pernikahan->id) }}"
