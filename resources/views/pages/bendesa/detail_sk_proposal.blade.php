...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <!-- /.content-header -->
            <div class="div ml-3">
                <a class="btn btn-warning" href="{{ url('sk_proposal_bendesa') }}" role="button"><i
                                ...
                                <div class="card-body">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <p>{{ $data->no_sk_proposal }}</p>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Tanggal Surat Proposal Keluar</label>
                                            <p>{{ date('d-M-Y', strtotime($data->tgl_sk_keluar)) }}</p>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Perihal Surat Proposal Keluar</label>
                                            <p>{{ $data->perihal_sk }}</p>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <img src="{{ url('foto_sk_proposal/' . $data->foto_sk_proposal) }}"
                                                class="img-thumbnail">
                                        </div>
                                    </div>
                                </div>
