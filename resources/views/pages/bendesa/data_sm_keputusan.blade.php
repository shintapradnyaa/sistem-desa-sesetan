                ...
                <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form class="row g-3"
                                action="{{ url('/store_sm_keputusan_sekretariat
                                                    ') }}"
                            ...
                            <tbody>
                                @foreach ($data as $index => $row)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url(
                                                'show_data_kematian_sekretariat
                                                                                ',
                                                $row->id,
                                            ) }}"
                                            ...
                                            <a href="{{ url(
                                                '/delete_sm_keputusan_sekretariat
                                                                                ',
                                                $row->id,
                                            ) }}"
