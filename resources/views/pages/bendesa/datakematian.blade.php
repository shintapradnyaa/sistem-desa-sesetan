                ...
                <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form class="row g-3" action="{{ url('/store_data_kematian_bendesa') }}" method="POST"
                            ...
                            <tbody>
                                @foreach ($data as $index => $row_kematian)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('show_data_kematian_bendesa', $row_kematian->id) }}"
                                                class="btn btn-sm btn-info">
                                                <i class="fas fa-info-circle"></i>
                                            </a>
                                            <a href="{{ url('edit_data_kematian_bendesa', $row_kematian->id) }}"
                                                class="btn btn-sm btn-warning">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <a href="{{ url('/delete_data_kematian_bendesa', $row_kematian->id) }}"
