...
<body id="page-top">
            ...
            <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
                ...
                <div class="col-lg-8 align-self-baseline">
                    <p class="text-white-75 mb-5">Sistem ini menampilkan data-data yang menyangkut tentang data
                        pernikahan, kematian dan surat keluar keputusan untuk warga Desa Adat Sesetan</p>
                </div>
            </div>
        </div>
    </header>
    ...
    <section class="page-section bg-dark text-black" id="contact">
        <div class="container px-4 px-lg-5">
            <h2 class="text-center text-white mt-0">Surat Keputusan</h2>
            <hr class="divider" />
            <div class="row gx-4 gx-lg-5">
                <div class="card">
                    <div class="card-body">
                        <table id="example3" class="table table-bordered table-striped table-hover">
                            <thead>
                                <tr align="center">
                                    ...
                                    <th scope="col">Surat Keluar Keputusan</th>
                                </tr>
                            </thead>
                            @php
                                $no = 1;
